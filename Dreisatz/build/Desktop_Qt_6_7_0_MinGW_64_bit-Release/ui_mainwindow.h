...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/icons/accessories-calculator-3.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/icons/application-exit.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionProgramm_beenden->setIcon(icon1);
        actionDreisatz = new QAction(MainWindow);
        actionDreisatz->setObjectName("actionDreisatz");
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/icons/address-book-new-2.ico"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/icons/emblem-notice.ico"), QSize(), QIcon::Normal, QIcon::Off);
        actionSolution->setIcon(icon3);
        actionBerechnen = new QAction(MainWindow);
        actionBerechnen->setObjectName("actionBerechnen");
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/icons/checkbox-2.ico"), QSize(), QIcon::Normal, QIcon::Off);
...
#endif // QT_CONFIG(statustip)
#if QT_CONFIG(shortcut)
        actionDreisatz->setShortcut(QCoreApplication::translate("MainWindow", "?", nullptr));
#endif // QT_CONFIG(shortcut)
...
#if QT_CONFIG(statustip)
        btnCalc->setStatusTip(QCoreApplication::translate("MainWindow", "Fehlenden Bezug berechnen", nullptr));
#endif // QT_CONFIG(statustip)
